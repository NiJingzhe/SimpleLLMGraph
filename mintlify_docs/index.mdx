...
**LLM calls as typed Python functions. Context as single source of truth. Prompts as code.**
...
Every piece of information the LLM sees is managed through a structured context pipeline. Changes happen through **mutations** — typed objects that describe what changed and why. The compile boundary transforms mutations into the final LLM request atomically. Nothing leaks. Nothing is silently overwritten.
